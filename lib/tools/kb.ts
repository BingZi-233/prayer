...
export const KB_TOOL_DESC =
  "语义检索产品知识库(注册/令牌/CLI 接入/绘图/条款/FAQ 等文档 + 人工沉淀)。政策、文档、FAQ、接入步骤等事实性问题,预检索片段不足或没有预检索时必须调用,并严格依据返回片段作答,不得凭记忆编造。价格、可用模型 ID、分组倍率、高峰价、平台公告等实时数据不要用本工具,改调 packy。参数 query 传用户问题或检索关键词(整句自然语言比堆关键词更准)。返回语义最相近的 top-5 片段(格式 [1]…[2]…),无命中时返回「知识库无相关内容。」。"
