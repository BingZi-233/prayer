...
- [ ] Step 1: 写 Backdrop/Popup/Close 失败合同并确认 RED
...
- [ ] Step 3: 迁移 AlertDialog

Overlay→Backdrop、Content→Popup、Cancel→Close；Action 使用普通 Button；保留 destructive variant 和确认语义。
...
- [ ] Step 1: 写 Positioner 失败合同并确认 RED
