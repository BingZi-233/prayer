...
function PopoverContent({
  ...
  return (
    <PopoverPrimitive.Portal>
      {/* fixed 定位的 Positioner 永远自建层叠上下文,z-index 必须给它:
          留在 Popup 上会被困在第 0 层,被 z-50 的 Dialog/Sheet 面板盖住。 */}
